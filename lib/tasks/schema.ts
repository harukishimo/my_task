...
export const createTaskSchema = z.object({
  ...
  requiresRequest: z.boolean().optional().default(false),
  isQuickTask: z.boolean().optional().default(false),
  estimatedWorkdays: z.number().finite().min(0.25).max(365).optional().default(1),
...
export const updateTaskSchema = z.object({
  ...
  requiresRequest: z.boolean().optional(),
  isQuickTask: z.boolean().optional(),
  estimatedWorkdays: z.number().finite().min(0.25).max(365).optional(),
  reviewOutlineAt: reviewDateTimeSchema.optional(),
  reviewMidAt: reviewDateTimeSchema.optional(),
  reviewAlmostAt: reviewDateTimeSchema.optional(),
