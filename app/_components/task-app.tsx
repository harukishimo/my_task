...
export default function TaskApp({ view }: { view: View }) {
  ...
  async function saveTask(input: { title: string; dueDate: string; isUrgent: boolean; isImportant: boolean }, task?: Task) {
  ...
  async function patchTask(task: Task, update: Record<string, unknown>, successText: string) {
    try {
  ...
  return (
    <div className="app-shell">
      ...
      {editing && <TaskModal task={editing.id ? editing : undefined} onClose={() => setEditing(null)} onSave={saveTask} />}
